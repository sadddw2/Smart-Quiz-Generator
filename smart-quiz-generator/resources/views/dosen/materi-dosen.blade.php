...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white shadow-md p-6">
        ...
        <nav class="space-y-3">
            ...
            <a href="{{ route('dosen.materi') }}" class="block bg-purple-100 text-purple-700 px-4 py-3 rounded-xl font-semibold">📄 Materi</a>
   ...
   👨‍🎓 Mahasiswa
    ...
    + Upload Materi
        ...
        <div class="bg-white rounded-2xl shadow overflow-hidden">
            ...
            <div class="p-5">
                <h2 class="font-bold text-lg">Total Materi {{ $materis->count() }}</h2>
            </div>
...
<td class="p-4">{{ $materi->kategori }}</td>
<td class="p-4">{{ $materi->semester }}</td>
    ...
    Download
        ...
        <form action="{{ route('dosen.materi.delete', $materi->id) }}"   
            method="POST">
