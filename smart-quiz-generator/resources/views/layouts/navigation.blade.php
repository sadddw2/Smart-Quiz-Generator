            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @guest
                    <div class="flex items-center gap-5">
                        <a href="{{ route('login') }}" class="font-medium text-slate-700 hover:text-indigo-600">
                            Login
                        </a>

                        <a href="{{ route('register') }}" class="bg-indigo-600 text-white px-6 py-3 rounded-xl">
                            Register
                        </a>
                    </div>
                @endguest
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @guest
                <div class="px-4 space-y-2">
                    ...
                    <a href="{{ route('register') }}" class="block text-indigo-600 font-semibold">
                        Register
                    </a>
                </div>
            @endguest
