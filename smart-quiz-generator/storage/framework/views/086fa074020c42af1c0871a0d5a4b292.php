...
<div class="max-w-4xl mx-auto bg-white rounded-2xl shadow p-8">
    ...
    <form method="POST" action="<?php echo e(route('materi.add.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\ACER\smart-quiz-generator\resources\views/data/tambah/add-materi.blade.php ENDPATH**/ ?>