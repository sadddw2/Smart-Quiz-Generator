...
<div class="flex min-h-screen">
    ...
    data-semester="<?php echo e(strtolower($materi->semester)); ?>">
                    ...
                    <td class="p-4">
                        <?php echo e($materi->dosen); ?>

                    </td>

                    <td class="p-4">
                        <?php echo e($materi->kategori); ?>

                    </td>

                    <td class="p-4">
                        <?php echo e($materi->semester); ?>

                    </td>

                    <td class="p-4">
                        <?php echo e($materi->created_at->format('d M Y, H:i')); ?>

                    </td>

                    <td class="p-4">
                        <?php echo e($materi->ukuran_file); ?>
...
</html><?php /**PATH C:\Users\ACER\smart-quiz-generator\resources\views/mahasiswa/materi-mahasiswa.blade.php ENDPATH**/ ?>