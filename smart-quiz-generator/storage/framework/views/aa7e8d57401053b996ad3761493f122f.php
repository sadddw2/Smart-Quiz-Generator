...
<input 
    ...
    class="w-full rounded-xl border-gray-3 mb-4">
            ...
            <p class="text-center text-white mt-6">
                Sudah Punya Akun?
                <a href="<?php echo e(route('login')); ?>" class="font-bold text-purple-200">
                    Login
                </a>
            </p>
        </div>
...
</html><?php /**PATH C:\Users\ACER\smart-quiz-generator\resources\views/auth/register.blade.php ENDPATH**/ ?>