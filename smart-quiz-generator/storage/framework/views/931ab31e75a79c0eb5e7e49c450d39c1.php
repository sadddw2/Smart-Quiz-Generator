...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white shadow-md p-6">
        ...
        <nav class="space-y-3">
            ...
            <a href="<?php echo e(route('materi.index')); ?>" class="flex gap-3 items-center bg-purple-100 text-purple-700 px-4 py-3 rounded-xl font-semibold">📄 Data Materi</a>
        ...
        <div class="bg-white rounded-2xl shadow overflow-hidden">
            ...
            <div class="flex justify-between items-center p-5">
                <h2 class="font-bold text-lg">
                    Total Materi <?php echo e($materis->count()); ?>
            ...
            <table class="w-full text-sm" id="materiTable">
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50 materi-row"
                        ...
                        data-dosen="<?php echo e(strtolower($materi->dosen)); ?>"
                        ...
                        <td class="p-4 text-center">
                            <div class="flex justify-center gap-3 items-center">
                                ...
                                <form action="<?php echo e(route('materi.delete', $materi->id)); ?>"
                                    method="POST">
                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\ACER\smart-quiz-generator\resources\views/data/materi.blade.php ENDPATH**/ ?>