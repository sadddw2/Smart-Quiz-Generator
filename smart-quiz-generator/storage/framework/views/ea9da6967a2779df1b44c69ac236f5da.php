...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white shadow-md p-6">
        ...
        <nav class="space-y-3">
            ...
            <a href="<?php echo e(route('dosen.index')); ?>" class="flex gap-3 items-center bg-purple-100 text-purple-700 px-4 py-3 rounded-xl font-semibold">🎓 Data Dosen</a>
        ...
        <div class="bg-white rounded-2xl shadow overflow-hidden">
            ...
            <div class="flex justify-between items-center p-5">
                <h2 class="font-bold text-lg">
                    Total Dosen <?php echo e($dosens->count()); ?>
            ...
            <table class="w-full text-sm" id="dosenTable">
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50 dosen-row"
                        data-name="<?php echo e(strtolower($dosen->name)); ?>"
                        data-email="<?php echo e(strtolower($dosen->email)); ?>"
                        data-status="<?php echo e(trim(strtolower($dosen->status ?? 'aktif'))); ?>">

                        <td class="p-4 text-center"><?php echo e($index + 1); ?></td>

                        <td class="p-4"><?php echo e($dosen->name); ?></td>

                        <td class="p-4"><?php echo e($dosen->email); ?></td>
    ...
    <span class="px-3 py-1 rounded-full text-xs font-semibold
        ...
        <?php echo e(ucfirst($status)); ?>
                        ...
                        <td class="p-4">
                            <?php echo e($dosen->created_at->format('d M Y, H:i')); ?>

                        </td>

                        <td class="p-4 text-center">
                            <div class="flex justify-center gap-3">
                                <a href="<?php echo e(route('users.edit', $dosen->id)); ?>" class="text-black text-lg">✏️</a>

                                <form action="<?php echo e(route('users.delete', $dosen->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\ACER\smart-quiz-generator\resources\views/data/dosen.blade.php ENDPATH**/ ?>