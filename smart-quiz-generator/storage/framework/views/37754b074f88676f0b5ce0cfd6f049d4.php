...
<div class="flex min-h-screen">
   ...
   👨‍🎓 Mahasiswa
    ...
    <main class="flex-1 p-8">
        ...
        <form method="POST" action="<?php echo e(route('dosen.kuis.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>

            <input type="hidden" name="dosen" value="<?php echo e(auth()->user()->name); ?>">
...
</html><?php /**PATH C:\Users\ACER\smart-quiz-generator\resources\views/dosen/tambah-kuis.blade.php ENDPATH**/ ?>