    ...
    <div class="relative z-10 w-full max-w-4xl px-6">
        ...
        <div class="bg-white/25 backdrop-blur-md rounded-3xl p-10 shadow-2xl">
            <div class="max-w-md mx-auto bg-white rounded-3xl p-10 shadow-xl">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" onsubmit="disableLoginButton()">
    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex justify-between items-center mb-6 text-sm">
                        ...
                        <a href="<?php echo e(route('password.request')); ?>" class="text-[#512CDF]">
                            Lupa Password?
                        </a>
                    </div>
            ...
            <p class="text-center text-white mt-6">
                Belum Punya Akun?
                <a href="<?php echo e(route('register')); ?>" class="font-bold text-purple-200">
                    Register
                </a>
            </p>
        </div>
...
</html><?php /**PATH C:\Users\ACER\smart-quiz-generator\resources\views/auth/login.blade.php ENDPATH**/ ?>