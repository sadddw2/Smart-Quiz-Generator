    ...
    <main class="flex-1 p-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                ...
                <p class="text-gray-500 mt-2">Selamat datang kembali, <?php echo e(auth()->user()->name); ?></p>
            </div>
<div class="relative">
    ...
    <button type="submit"
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
            ...
            <a href="<?php echo e(route('kuis.index')); ?>" class="bg-white p-5 rounded-2xl shadow hover:shadow-lg">
                <div class="text-3xl mb-2">📝</div>
                <h3 class="font-bold">Total Kuis</h3>
                <p class="text-2xl font-bold"><?php echo e($totalKuis); ?></p>
                <p class="text-xs text-purple-600">Lihat Semua →</p>
            </a>

            <a href="<?php echo e(route('hasilkuis.index')); ?>" class="bg-white p-5 rounded-2xl shadow hover:shadow-lg">
                <div class="text-3xl mb-2">📄</div>
                <h3 class="font-bold">Total Soal</h3>
                <p class="text-2xl font-bold"><?php echo e($totalSoal); ?></p>
                <p class="text-xs text-purple-600">Lihat Semua →</p>
            </a>

            <a href="<?php echo e(route('mahasiswa.index')); ?>" class="bg-white p-5 rounded-2xl shadow hover:shadow-lg">
                <div class="text-3xl mb-2">👨‍🎓</div>
                <h3 class="font-bold">Total Mahasiswa</h3>
                <p class="text-2xl font-bold"><?php echo e($totalMahasiswa); ?></p>
                <p class="text-xs text-purple-600">Lihat Semua →</p>
            </a>
            ...
            <div class="bg-white p-5 rounded-2xl shadow">
                ...
                <p class="text-2xl font-bold"><?php echo e($totalPengerjaan); ?></p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white rounded-2xl shadow p-6">
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $kuiss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kuis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b">
                            <td class="p-3"><?php echo e($kuis->judul_kuis); ?></td>
                            <td class="p-3"><?php echo e($kuis->dosen); ?></td>
                            <td class="p-3"><?php echo e($kuis->jumlah_soal); ?></td>
                            <td class="p-3">
                ...
                <div class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $aktivitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex justify-between border-b pb-3">
                            <div>
                                <p class="font-semibold"><?php echo e($item->icon); ?> <?php echo e($item->aktivitas); ?></p>
                                <p class="text-sm text-gray-500"><?php echo e($item->created_at->diffForHumans()); ?></p>
                            </div>
                            <span class="text-sm text-gray-400"><?php echo e($item->waktu); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
</html><?php /**PATH C:\Users\ACER\smart-quiz-generator\resources\views/dashboard/dosen.blade.php ENDPATH**/ ?>